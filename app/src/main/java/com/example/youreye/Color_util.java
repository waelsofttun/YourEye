...
public class Color_util {
    ...
    //Liste des couleur  de type ColorName
    ...
    /**
     * Retourne le couleur par partir des 3 valeur suivante INT
     *
     * @param r red
     * @param g green
     * @param b blue
...
// Classe de Model Color Name
    public class ColorName {
       ...
       //The mean squared error (MSE) CALCLUL DE taux d'erreur ou de correspandance
